...
import com.feedeo.restfb.JsonMapper;
...
public class Utility extends Application {
    ...
    public static String userPicFile = null;
    public static boolean userPicAvl = false;

    public static SimpleDateFormat formatter = new SimpleDateFormat("EEE MMM d hh:mm:ss yyyy");
